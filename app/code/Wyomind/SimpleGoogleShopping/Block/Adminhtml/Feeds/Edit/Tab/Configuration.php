...
class Configuration extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            'class' => 'debug',
            'id' => 'samplereport_url',
            'name' => 'samplereport_url',
            'label' => __('Sample report url'),
            'required' => false
                ]
        );
        $model->setData('samplereport_url', $this->getUrl('*/*/samplereport'));
        ...
        $fieldset->addField(
            ...
            'required' => true,
            'style' => 'height:100px',
            "note" => __('Description of the data feed (internal use only)') . '<br><br><span id="preview-refresh-btn" class="preview-refresh-btn preview-goto-btn">
                    <span class="preview-refresh-btn-icon"></span>
                    <span>' . __("Generate a preview") . '</span>
                    </span>',
                ]
        );
        $fieldset->addField(
