...
class Status extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $script = "<script language='javascript' type='text/javascript'>var updater_url='" . $this->getUrl('simplegoogleshopping/feeds/updater') . "';</script>";
        return $script . "<span class='grid-severity-$severity updater' cron='" . $row->getCronExpr() . "' id='feed_" . $row->getSimplegoogleshoppingId() . "'><span>" . ($status) . "</span></span>";
    }
}
