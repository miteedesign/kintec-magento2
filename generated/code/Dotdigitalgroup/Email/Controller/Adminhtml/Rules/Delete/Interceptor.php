...
class Interceptor extends \Dotdigitalgroup\Email\Controller\Adminhtml\Rules\Delete implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Store\Model\StoreManagerInterface $storeManagerInterface, \Dotdigitalgroup\Email\Model\Rules $rules)
    {
        $this->___init();
        parent::__construct($context, $storeManagerInterface, $rules);
    }
