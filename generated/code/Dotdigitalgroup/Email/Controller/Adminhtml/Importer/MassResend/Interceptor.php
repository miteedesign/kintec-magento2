...
class Interceptor extends \Dotdigitalgroup\Email\Controller\Adminhtml\Importer\MassResend implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Dotdigitalgroup\Email\Model\ResourceModel\Importer $importer)
    {
        $this->___init();
        parent::__construct($context, $importer);
    }
