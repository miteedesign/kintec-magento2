...
class BaseController extends Controller
{
    ...
    public function actionAjaxReset()
    {
        ...
        if ($step) {
            ...
            if ($ck['allowed']) {
                Yii::log("Start resetting data migration in step #{$stepIndex}...", 'info', 'ub_data_migration');
                ...
                $rs['errors'] = Yii::t('frontend', "You can't reset this step. You have to reset Step #%s first.", array('%s' => $ck['back_step_index']));
            }
        } else {
