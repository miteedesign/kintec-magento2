 ...
 */
class Mage2SalesInvoiceGrid extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			/**
			 * base_grand_total is new from Magento 2.1.0 but it's value can null. And we haven't declare this
			 */
			//array('subtotal, shipping_and_handling, grand_total, base_grand_total', 'length', 'max'=>12),
	 ...
	 * @return Mage2SalesInvoiceGrid the static model class
	 */
